...
var getMode_1 = require("../tools/getMode");
var merge_1 = require("../tools/merge");
var downloadURI_1 = require("../tools/downloadURI");
var QRCanvas_1 = require("./QRCanvas");
var QRSVG_1 = require("./QRSVG");
var drawTypes_1 = require("../constants/drawTypes");
var QROptions_1 = require("./QROptions");
var sanitizeOptions_1 = require("../tools/sanitizeOptions");
var qrcode_generator_1 = require("qrcode-generator");
                    ...
                    case 1:
                        ...
                        if (extension.toLowerCase() === "svg") {
                            ...
                            return [2 /*return*/, new Promise(function (resolve) {
                                    return element.getCanvas().toBlob(resolve, "image/" + extension, 1);
                                })];
                        }
                        return [2 /*return*/];
                }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (extension.toLowerCase() === "svg") {
                            ...
                            downloadURI_1["default"](url, name + ".svg");
                        }
                        else {
                            url = element.getCanvas().toDataURL("image/" + extension);
                            downloadURI_1["default"](url, name + "." + extension);
                        }
                        return [2 /*return*/];
                }
            });
